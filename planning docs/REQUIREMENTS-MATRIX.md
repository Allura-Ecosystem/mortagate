...
| FR-24 | Conversational Agentforce agent (Veridact Auditor Copilot) over the diagnosis action | Part 2 / Penasoto → Agentforce | agent spec `specs/veridactAgent.yaml`; agent object created via `sf agent create` on `veridact-af` | activation blocked — needs Agent Builder UI (R-10) | 🟡 |
